return {
  {
    ...
    keys = {
      ...
      { '<Space>sf', function() require('telescope.builtin').lsp_document_symbols({ symbols = "function" }) end,  desc = 'LSP Functions (document)' },
      { '<Space>sF', function() require('telescope.builtin').lsp_workspace_symbols({ symbols = "function" }) end, desc = 'LSP Functions (workspace)' },
