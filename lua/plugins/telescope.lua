return {
  {
    ...
    keys = {
      ...
      },
      {
        "<Space>dw",
        function()
          require("telescope.builtin").diagnostics({ severity = "warning" })
        end,
        desc = "LSP warnings",
      },
      {
      ...
      },
      {
        "<Space>sf",
        function()
          require("telescope.builtin").lsp_document_symbols({ symbols = { "function", "method" }, symbol_width = 50 })
        end,
        desc = "LSP Functions (document)",
      },
      {
        "<Space>sF",
        function()
          require("telescope.builtin").lsp_workspace_symbols({ symbols = { "function", "method" }, symbol_width = 50 })
        end,
        desc = "LSP Functions (workspace)",
      },
      {
        "<Space>b",
        function()
      ...
      },
      {
        "gdt",
        function()
          require("cfg.utils").fntab(require("telescope.builtin").lsp_definitions, { zz = true })
        end,
      ...
      },
      {
        "gR",
        function()
          require("cfg.utils").fntab(require("telescope.builtin").lsp_references)
        end,
        desc = "Go to References (new tab)",
      },
      {
        "gdh",
        function()
          require("cfg.utils").split("h", require("telescope.builtin").lsp_definitions, { zz = true })
        end,
        desc = "Go to Definition (split left)",
      },
      {
        "gdj",
        function()
          require("cfg.utils").split("j", require("telescope.builtin").lsp_definitions, { zz = true })
        end,
        desc = "Go to Definition (split down)",
      },
      {
        "gdk",
        function()
          require("cfg.utils").split("k", require("telescope.builtin").lsp_definitions, { zz = true })
        end,
        desc = "Go to Definition (split up)",
      },
      {
        "gdl",
        function()
          require("cfg.utils").split("l", require("telescope.builtin").lsp_definitions, { zz = true })
        end,
        desc = "Go to Definition (split right)",
      },
    },
    dependencies = {
