return {
  {
    ...
    keys = {
      ...
      { 'gdt',       function() require('config.utils').FnNewTab(require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (new tab)' },
      { 'gdh',       function() require('config.utils').split('h', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split left)' },
      { 'gdj',       function() require('config.utils').split('j', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split down)' },
      { 'gdk',       function() require('config.utils').split('k', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split up)' },
      { 'gdl',       function() require('config.utils').split('l', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split right)' },
    },
    dependencies = {
