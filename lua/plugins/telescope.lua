return {
  {
    ...
    keys = {
      ...
      { '<Space>sw', function() require('telescope.builtin').lsp_workspace_symbols() end, desc = 'LSP Symbols (workspace)' },
      { '<Space>sd', function() require('telescope.builtin').lsp_document_symbols() end, desc = 'LSP Symbols (document)' },
      ...
      { '<Space>sf', function() require('telescope.builtin').lsp_document_symbols({ symbols = {"function", "method"} }) end, desc = 'LSP Functions (document)' },
      { '<Space>sF', function() require('telescope.builtin').lsp_workspace_symbols({ symbols = {"function", "method"} }) end, desc = 'LSP Functions (workspace)' },
      { '<Space>b',  function() require('telescope.builtin').buffers({ sort_mru = true, sort_lastused = true }) end, desc = 'Buffers' },
      ...
      { 'gdt',       function() require('utils').FnNewTab(require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (new tab)' },
      { 'gdh',       function() require('utils').SplitInDirection('h', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split left)' },
      { 'gdj',       function() require('utils').SplitInDirection('j', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split down)' },
      { 'gdk',       function() require('utils').SplitInDirection('k', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split up)' },
      { 'gdl',       function() require('utils').SplitInDirection('l', require('telescope.builtin').lsp_definitions, { zz = true }) end, desc = 'Go to Definition (split right)' },
    },
    dependencies = {
