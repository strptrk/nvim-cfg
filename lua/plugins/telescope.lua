return {
  {
    ...
    keys = {
      ...
      { 'gdt',       function() Utils.FnNewTab(require('telescope.builtin').lsp_definitions, { zz = true }) end,                    desc = 'Go to Definition (new tab)' },
      ...
      { 'gdh',       function() Utils.SplitInDirection('h', require('telescope.builtin').lsp_definitions, { zz = true }) end,       desc = 'Go to Definition (split left)' },
      { 'gdj',       function() Utils.SplitInDirection('j', require('telescope.builtin').lsp_definitions, { zz = true }) end,       desc = 'Go to Definition (split down)' },
      { 'gdk',       function() Utils.SplitInDirection('k', require('telescope.builtin').lsp_definitions, { zz = true }) end,       desc = 'Go to Definition (split up)' },
      { 'gdl',       function() Utils.SplitInDirection('l', require('telescope.builtin').lsp_definitions, { zz = true }) end,       desc = 'Go to Definition (split right)' },
