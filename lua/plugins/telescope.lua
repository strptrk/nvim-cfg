return {
  {
    ...
    keys = {
      ...
      { '<Space>oc', function() require('telescope.builtin').lsp_outgoing_calls() end, desc = 'Outgoing Calls' },
      { '<Space>ic', function() require('telescope.builtin').lsp_incoming_calls() end, desc = 'Incoming Calls' },
